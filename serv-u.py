...
#Define session
#Session paramaters 
SESSION_FILENAME = "serv-u-session" 		# Keeps track of the current fuzzing state
...
if debugmode == 0: 
	...
	target.procmon_options = {
		"proc_name" : "Serv-U.exe",
		"stop_commands" : ['wmic process where (name="Serv-U.exe") call terminate'],
		"start_commands" : ["C:\RhinoSoft\Serv-U\Serv-U.exe"]
	}
